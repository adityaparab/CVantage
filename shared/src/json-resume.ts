...
export const jrLocationSchema = z.object({
  address: str(300),
  postalCode: str(20),
  city: str(120),
...
export const jrProfileSchema = z.object({
  network: str(60),
  username: str(120),
  url,
});

export const jrBasicsSchema = z.object({
  name: str(200),
  label: str(200),
  image: url,
...
export const jrWorkSchema = z.object({
  name: str(200),
  location: str(200),
...
export const jrVolunteerSchema = z.object({
...
export const jrEducationSchema = z.object({
  institution: str(200),
  url,
  area: str(200),
  studyType: str(100),
...
export const jrAwardSchema = z.object({
  title: str(200),
  date: partialDate,
  awarder: str(200),
  summary: str(2000),
...
export const jrCertificateSchema = z.object({
  name: str(200),
  date: partialDate,
  issuer: str(200),
  url,
...
export const jrPublicationSchema = z.object({
  name: str(300),
  publisher: str(200),
...
export const jrSkillSchema = z.object({
  name: str(120),
  level: str(60),
  keywords: z.array(z.string().max(120)).optional(),
});

export const jrLanguageSchema = z.object({
  language: str(80),
  fluency: str(80),
});

export const jrInterestSchema = z.object({
  name: str(120),
  keywords: z.array(z.string().max(120)).optional(),
});

export const jrReferenceSchema = z.object({
  name: str(200),
  reference: str(3000),
});

export const jrProjectSchema = z.object({
  name: str(200),
...
export const jrMetaSchema = z.object({
  canonical: url,
  version: str(20),
  lastModified: str(40),
});
